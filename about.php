...
<?php
  ...
  ?><br>
<div class="container-fluid text-center text-justify" style="padding:0px 0px 30px 100px;">
<div class="container text-center" > 
  <div class="row content">
    <div class="col-sm-12" >
       <div class='col-sm-10'>
      <h1 id="font" style='color:#a95a5a;'>About Us </h1><br>
...
<h1 align="center"id="font" style='color:#a95a5a;' >Our Services </h1><br>
