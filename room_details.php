...
<body style="margin-top:50px;">
  ...
  <div class="carousel-inner">
    <div class="item active">
      <img src="image/DeluxeRoom/delux_img1.jpg"class="thumbnail" alt="img1">
    </div>

    <div class="item">
      <img src="image/DeluxeRoom/delux_img2.jpg"class="thumbnail" alt="im2">
    </div>

    <div class="item">
       <img src="image/DeluxeRoom/delux_img3.jpg"class="thumbnail" alt="im3">
    </div>

    <div class="item">
       <img src="image/DeluxeRoom/delux_img4.jpg"class="thumbnail" alt="img4">
    </div>

    <div class="item">
       <img src="image/DeluxeRoom/delux_img5.jpg"class="thumbnail" alt="img5">
    </div>

    <div class="item">
       <img src="image/DeluxeRoom/delux_img7.jpg"class="thumbnail" alt="img6">
    </div>
  </div>
...
?>
    ...
    <div class="row">
      ...
      <a href="Login.php?type=<?php echo $res['type']; ?>" class="btn btn-danger">Book Now</a><br><br>
      </div>
	</div>
				<div class="col-sm-3">
