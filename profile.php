...
if(isset($update))
{
$que="update create_account set name='$name',password='$pass',mobile='$mob',address='$add',gender='$gender' where email='$eid'";
           ...
           <div class="row">
              <div class="control-label col-sm-4"><h4>Gender:</h4></div>
                ...
                <div class="custom-control custom-radio">
                  <input type="radio" class="custom-control-input" name='gender' value='male'<?php echo ($result['gender']=='male') ? 'checked="checked"':'';?>>male
                  &nbsp;                 
                  <input type="radio"class="custom-control-input" name='gender' value='female'<?php echo ($result['gender']=='female') ? 'checked="checked"':'';?>>female
                </div>
